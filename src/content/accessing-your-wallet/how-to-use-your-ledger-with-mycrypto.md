...
It's time to access our Nano S using MyCrypto! In order to do so, go to [MyCrypto.com](https://ethereumproject.github.io/etherwallet/), enter the "View & Send" tab, and click the "Ledger" option.
...
Ledger has an extensive knowledge base that you can find [here](https://ledger.zendesk.com/), as well as MyCrypto's [here](https://support.ethereumcommonwealth.io/). There is a big chance that it's already listed on one of them. If not, feel free to contact either [Ledger](https://ledger.zendesk.com/hc/en-us/requests/new) or [MyCrypto](mailto:support@mycrypto.com).
