...
It's time to access our Nano S using MyCrypto! In order to do so, go to [MyCrypto](https://ethereumproject.github.io/etherwallet/) and click the "Ledger" option.
