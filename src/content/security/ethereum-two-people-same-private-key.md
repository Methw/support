...
- [Couldn't everybody put in random private keys, look for a balance, and send to their own address?](https://support.ethereumcommonwealth.io/faq/couldnt-everybody-put-in-a-random-key-and-send-to-own-address.html)
